...
import { Panel, UserAccountUsername,UserAccount, UserAccountAvatar } from './styles'
  ...
  return (
    <Panel>
            ...
            <UserAccount>
              ...
              <svg color='gray' transform='rotate(90)' width="2.5rem" height="2.5rem"  xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
